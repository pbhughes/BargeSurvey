...
using BargeSurveyMobile.Models;
using BargeSurveyMobile.Providers;
using BargeSurveyMobile.Results;
using BargeSurveyMobile.Models.Utility;
using System.Net;

namespace BargeSurveyMobile.Controllers
{
    [Authorize]
